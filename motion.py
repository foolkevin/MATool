...
if __name__ == "__main__":
    ...
    if args.video:
        # analyzer.predict_sequence(args.video)
        # analyzer.predicted = True
        # analyzer.pathDict[args.video]['pred'] = os.path.join(args.predict_path, args.video + '.txt')
        analyzer.analyze_sequence(args.video)
    else:
        # analyzer.predict()
        # analyzer.predicted = True
        # analyzer.pathDict = analyzer.get_files_path()
        analyzer.analyze()